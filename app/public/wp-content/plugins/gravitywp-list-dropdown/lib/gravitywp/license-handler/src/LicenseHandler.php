 ...
 * @license proprietary?
 *
 * Modified by __root__ on 05-July-2022 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */
namespace GravityWP\List_Dropdown\GravityWP\LicenseHandler;
...
class LicenseHandler {
	...
	public function __construct( $gwp_addon_class, $license_hash, $plugin_file_path ) {
		...
		$this->_appsero_client = new \GravityWP\List_Dropdown\Appsero\Client( $license_hash, $this->_addon_title, $plugin_file_path );
	...
	public function plugin_settings_license_fields() {
		...
		$license_field = array(
			...
			'input_type'          => 'password',
			'class'               => 'medium',
			'default_value'       => '3Bs4AzdB-e9I6-12A4-dmT5-57Ot4crw7qiP',
